    ...
    <div className="lg:pl-24 mb-20 sm:mb-28">
      ...
      <div className="static">
          <div className="relative left-5 bottom-20 h-[300px] w-[300px] sm:w-full  sm:h-[500px] flex justify-center items-center lg:col-start-3 lg:col-span-4">
            ...
            <Image className='absolute z-0 no-select' src='/squareDoodle.png' alt="doodle" height={514} width={514}/>

            <Image className='relative z-10 top-16 drop-shadow-[0_10px_10px_rgba(0,0,0,0.6)] no-select' src='/personOnTable.png'  alt="person" height={472} width={400}/>
          </div>
      </div>
